...
function getImagePosition(image) {
	var _getXYPosition = getXYPosition(image),
	    ...
	    bottom = _getXYPosition.bottom,
	    right = _getXYPosition.right;
